...
template<class T> void DListsort<T>::mergesort(int thr)
{
    ...
    // Divide: sort n elements -> sort two subsequence with n/2 elements
    // Conquer: sort subsequence using mergesort. If size too small, sort using insertion sort or selection sort
